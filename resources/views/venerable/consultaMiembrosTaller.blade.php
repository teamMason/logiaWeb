        ...
        <div class="row-fluid">
            <div class="panel panel-default">
                <div class="panel-heading ">
                    <strong style="margin-right: 15px;"> Miembros registrados de los diferentes talleres.
                        prueba</strong> <strong>Hay {{$miembros->total()}} Registros </strong>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a data-toggle="modal" title="Ver información"
                                                           data-target="#infoEdit-{{$s->id}}">Editar</a></li>
                                                    <li><a data-toggle="modal" title="Ver información"
                                                           data-target="#info-{{$s->id}}">Ver</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modai-body" align="center">
                        <img src="../../assets/img/portfolio/Logo1.png" class="img-circle img-responsive" alt=""
                            ...
                            <div class="tabbable">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="aumentos-{{$s->id}}" class="tab-pane text-center">
                                        <div class="alert-warning">
                                            <p>Te Recordamos que los aumentos y exaltaciones generan un costo en tu
                                                recibo mensual expedido por gran logia.
                                                Debes precionar el boton el día que realisarás la ceremodia
                                                correspondiente.
                                            </p>
                                        </div>
                                        <div class=" modal-footer " align="center">
                                    ...
                                    <div id="datos-{{$s->id}}" class="tab-pane active">
                                        ...
                                        <fielset>
                                            <input type="text" name='nombre' placeholder="Nombre" value="{{$s->nombre}}"
                                                   class="form-control " disabled><br>
                                            <input type="text" name='apellido' placeholder="Apellido"
                                                   value="{{$s->apellido}}" class="form-control" disabled><br>
                                            ...
                                            <input type="email" name='email' placeholder="Correo Electrónico"
                                                   class="form-control" value="{{$s->email}}"><br>
                                            <input type=tel id="telefono" name='telefono' placeholder="Telefono"
                                                   value="{{$s->telefono}}" class="form-control"><br>
                                            <input type=tel id="telefonoCel" name='telefonoCel'
                                                   placeholder="Telefono de Casa" value="{{$s->telefonoCel}}"
