	...
	<div class="row-fluid" id = "articleSection">
		...
		<div class="container">
			...
			<div class="col-md-8" align = "left">
				<span ><i class="fa fa-user"></i> {{$posts->autor}} </span><span> | <i class="fa fa-calendar"></i> {{substr($posts->created_at, 0, 10 )}} </span><br>
				...
				<div class="fb-comments" data-href="http://granlogiadeedobc.com/news/{{$posts->slug}}" data-width="100%" data-numposts="10"></div>
			</div>
		</div>
	</div>
