                        ...
                        <div class="container">
                            <div class="row">
                                <table class="table table-striped table-hover ">
                                    ...
                                    <th class="hidden-sm hidden-xs">Acciones</th>
                                    </thead>
                                    <tbody>
                                    @foreach($venerables as $s)
                                        <tr>
                                            ...
                                            @if($s->token != null)
                                                <td class="alert-warning alert-warning hidden-sm hidden-xs">Espera de aprobación</td>
                                            @else
                                                <td class="alert-success alert-success hidden-sm hidden-xs">Activo</td>
                                            @endif
                                            <td>
                                                <div class="btn-group">
