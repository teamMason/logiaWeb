                            ...
                            <div class="container">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <fielset>
                                        ...
                                        <input input type=tel id="telefono" name='telefono' placeholder="Teléfono Fijo"
                                               class="form-control"><br>
                                        <input input type=tel id="telefonoCel" name='telefonoCel'
                                               placeholder="Teléfono Celular" class="form-control"><br>
