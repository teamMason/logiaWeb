        ...
        <div class="row-fluid">
            <div class="panel panel-default">
                <div class="panel-heading ">
                    ...
                    <strong>Hay {{$miembros->total()}} Registros </strong>
                ...
                <div class="panel-body">
                    ...
                    <div class="container" id="admin">
                        <div class="row">
                            ...
                            <div class="form-group">
                                <?php $l = portalLogia\Taller::lists('nombreTaller', 'id')->toArray(); array_unshift($l,
                                        'Todos los Talleres'); ?>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a data-toggle="modal" title="Editar información"
                        ...
                        <div class="modal-body">
                            ...
                            <fielset>
                                <input type="text" name='nombre' placeholder="Nombre" value="{{$s->nombre}}"
                                       class="form-control " onblur="this.value=this.value.toUpperCase()" required><br>
                                <input type="text" name='apellido' placeholder="Apellido" value="{{$s->apellido}}"
                                       class="form-control" onblur="this.value=this.value.toUpperCase()" required><br>
                                ...
                                <input type=tel id="telefonoCel" name='telefonoCel' placeholder="Telefono de Casa"
                                       value="{{$s->telefonoCel}}" class="form-control"><br>
                            </fielset>
                        </div>
                        <div class="modal-footer ">
