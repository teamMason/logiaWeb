        ...
        <div class="row-fluid">
            <div class="panel panel-default">
                <div class="panel-heading ">
                    <strong>Solicitudes enviadas por los talleres.</strong>
                </div>
                            ...
                            <table class="table table-striped table-hover" action="javascript:alert('Submitted')">
                                ...
                                @foreach($solicitudes as $s)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="">
                                                <a class="btn btn-info" type="button" class="btn btn-info btn-lg"
                                                   data-toggle="modal"
                                                   title="Ver información" data-target="#info-{{$s->id}}"><i
                                                            class="fa fa-info"></i></a>
                                                <a href="#my_modal" data-toggle="modal" data-book-id="{{$s -> id}}"
                                                   class="btn btn-danger" title="Borrar Solicitud"><i
