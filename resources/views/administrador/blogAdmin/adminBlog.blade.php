                ...
                <div class="panel-heading ">
                    <div class="container-fluid">
                        ...
                        <div class="pull-right ">
                            <a href="{{route('crearArticle')}}" class="btn btn-success " class="text-right"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="visible-lg visible-md">
                                            <a href="admin/post/{{$p -> id}}/edit" class="btn btn-warning "><i
                                                        class="fa fa-edit"></i></a>
                                            <a href="#my_modal" data-toggle="modal" data-book-id="{{$p -> id}}"
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="#my_modal" data-toggle="modal"
                                                           data-book-id="{{$p -> id}}">Eliminar</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
