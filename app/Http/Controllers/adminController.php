...
class adminController extends Controller
{
    ...
    {
        $buzon        = Contacto::where('leido', '!=', 'leido')->count();
        $aprobaciones = Solicitud::where('estadoSolicitud', 'false')->count();
        $votaciones   = Solicitud::where(function ($query) {
            $query->where('estadoIniciacion', 'false');
        })->where('estadoSolicitud', 'true')->count();

        $alta   = Solicitud::where(function ($query) {
            $query->where('estadoIniciacion', 'true');
        })->where('estadoAlta', 'false')->count();



        return view('administrador.blogAdmin.admin')
            ->with(compact('buzon', 'aprobaciones','votaciones','alta'));
    ...
    public function blog()
    {
        ...
        return view('administrador.blogAdmin.adminBlog')->with('posts', $posts);
    }
    ...
    public function edit($id)
    {
        ...
        return view('administrador.blogAdmin.editArticle')->with('posts', $posts);
    ...
    public function crearArticulo()
    {
        ...
        return \Redirect::route('adminBlog')->with('alert', 'Tu publicación ha sido creada con éxito!');
    ...
    public function verBuzon()
    {
        ...
        return view('administrador.contacto.contacto')->with('buzon', $buzon);
    ...
    public function biblioteca()
    {
        ...
        return view('administrador.libros.biblioteca')->with('libros', $libros);
    ...
    public function uploadBook(Request $request)
    {
        ...
        foreach ($file as $files) {
            ...
            if ($v->fails()) {
                ...
                return \Redirect::route('biblioteca')->with('alert-danger',
                        'Algunos de los Archivos que desea subir son demasiado pesados o no tienen un formato correcto.');
            } else {
        ...
        return \Redirect::route('biblioteca')->with('alert', 'Archivos Subidos exitosamente.');
    ...
    public function deleteBook()
    {
        ...
        if ( ! is_null($librito) and $librito->editado == 'true') {
            ...
            return \Redirect::route('biblioteca')->with('alert', 'El libro se ha Borrado Correctamente');
        ...
        return \Redirect::route('biblioteca')->with('alert', 'Ha ocurrido un error el libro no se encuentra');
    ...
    public function editBook(Request $request, $id)
    {
        ...
        return \Redirect::route('biblioteca')->with('alert', 'El libro se ha Modificado Correctamente');
